...
### DzzOffice2.3.1主要更新内容

### 网盘功能优化
- SQL语法错误修复：解决了SQL语法报错的问题，提升了系统的稳定性。
- 语言翻译完善：修复了取消收藏功能中语言未翻译的问题，提升了用户体验。
- 分享权限设置：新增分享文件时设置分享权限的功能，包括禁用下载、仅登录查看、可编辑以及禁用预览权限，增强了文件分享的安全性。
- 短链接分享：分享文件的链接统一为短链接，便于分享和使用，提升了分享的便捷性。
### 应用管理功能增强
...
- 文件管理重构：采用Bootstrap表格插件重构页面，使界面更加友好、便捷。
