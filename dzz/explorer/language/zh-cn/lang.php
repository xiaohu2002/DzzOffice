...
$lang = array(
    ...
    'changecreater' => '改变创始人',
    'change_creater' => '将{groupname}的创始人由{oldusername}改变为{newusername}',
    ...
    'reach' => '到',
    'creat_folder' => '创建了文件夹<a class="text-primary" href="javascript:;" onclick=\"location.hash="{hash}";\">{position}{foldername}</a>',
    'creat_file' => '在<a class="text-primary" href="javascript:;" onclick=\"location.hash="{hash}";\">{position}</a>创建了文件<span class="text-primary">{position}{title}</span>',
    'update_new_version' => '更新了<a class="text-primary" href="javascript:;" onclick=\"location.hash="{hash}";\">>{position}{title}</a>文件版本',
    'create' => '创建',
    'create_group' => '创建{groupname}',
    'update_group_setting' => '更改了设置',
    'set_group_perm' => '更改了权限',
    'setperm' => '更改权限',
    'set_folder_perm' => '更改了{position}的权限',
    'update_group_name' => '将{oldname}重命名为{newname}',
    'update_groupname' => '重命名',
    'update_setting' => '更改设置',
    'add_members' => '添加了成员{member}',
    'addmember' => '添加成员',
    'remove_member' => '移除成员',
    'update_perm' => '修改权限',
    ...
    'deltag' => '删除',
    'addtag' => '添加',
    'del_tags' => '删除了<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{position}\';">{filename}</a>{tagname}',
    'add_tags' => '给<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{position}</a>添加了<span class="badge bg-primary">{tagname}</span>标签',
    'add_comment' => '发表了评论:<span class="text-dark">{msg}</span>',
    'addcomment' => '评论',
    'edit_groupsetting' => '修改了设置',
    ...
    'delfile' => '删除文件',
    'delfolder' => '删除文件夹',
    'delete_file' => '删除文件<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{position}{filename}</a>',
    'delete_folder' => '删除文件夹<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{position}{filename}</a>',
    'has_no_privilege_file' => '含有无权限文件',
    'finallydelete' => '彻底删除',
    'finallydel_file' => '彻底删除了文件/夹<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{position}{filename}</a>',
    'recover_error' => '恢复失败',
    'recover_file' => '恢复了文件<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{position}</a>中的<span class="text-primary">{filename}</span>',
    'recoverfile' => '恢复',
    'recover_success' => '恢复成功',
    'rename' => '重命名',
    'rename_file' => '重命名文件<a class="text-primary" href=\'javascript:;\' onclick="location.hash=\'{hash}\';">{position}{filename}</a>为<span class="text-primary">{newfilename}</span>',
    'rename_msg' => '重命名文件<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{position}{filename}</a>为<span class="text-primary">{newfilename}</span>',
    'share' => '分享',
    'share_file' => '分享了文件/夹<span class="text-primary">{filename}</span>',
    'share_not_exists' => '分享不存在',
    'cancle_share' => '取消文件/夹{filename}的分享',
    'share_notallow_from_different_zone' => '分享文件不允许源自不同位置',
    'moved_folder' => '自<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{olderposition}</a>移入文件夹{foldername}',
    'moved_file' => '自<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{olderposition}</a>移入文件{filename}',
    'move_folder' => '移动文件夹<span class="text-primary">{foldername}</span>到<a href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{newposition}</a>',
    'move_file' => '移动文件<span class="text-primary">{filename}</span>到<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{newposition}</a>',
    'movefile' => '移出文件',
    'movefolder' => '移出文件夹',
    'movedfolder' => '移入文件夹',
    'movedfile' => '移入文件',
    'update_version' => '更新了<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{position}{title}</a>的版本',
    'updatevesion' => '更新版本',
    'collect' => '收藏',
    'downpackage' => '打包下载',
    'iconview_2' => '中等图标',
    ...
    'down' => '下载',
    'downfile' => '下载了<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{position}{files}</a>',
    'downfiles' => '下载了<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{position}{files}</a>等',
    'comment_not_exists' => '评论不存在',
    'delete_error' => '删除失败',
    'setprimaryversion' => '更改主版本',
    'setprimary_version' => '更改<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{position}</a>下的{oldname}以{name}为主版本',
    'edit_versionname' => '更改了<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{position}{filename}</a>的{oldvname}版本名称为{name}',
    'editversionname' => '修改版本名称',
    'edit_file' => '修改了<a class="text-primary" href=\'javascript:;\'  onclick="location.hash=\'{hash}\';">{position}{title}</a>的内容',
    'edit' => '编辑',
    ...
    'explorer_comment_at' => '{author}在文件/夹:<a class="text-primary" href="{url}">{fname}</a>的评论中提到我<b>{comment}</b>',
    'explorer_comment_at_wx' => '{author}在群组:{fname}的评论中提到我<b>{comment}</b>',
    'explorer_comment_at_redirecturl' => '{url}',

    //发表评论，通知群组作者
    'explorer_comment_mydoc_title' => '评论了我的{fname}',
    'explorer_comment_mydoc' => '{author}在文件/夹:<a class="text-primary" href="{url}">{fname}</a>中发表了评论<b>{comment}</b>',
    'explorer_comment_mydoc_wx' => '{author}在文件/夹:{fname}中发表了评论<b>{comment}</b>',
    'explorer_comment_mydoc_redirecturl' => '{url}',

    //回复评论，通知被回复者
    'explorer_comment_reply_title' => '回复了我的评论',
    'explorer_comment_reply' => '{author}在群组:<a class="text-primary" href="{url}">{fname}</a>中回复了我的评论<b>{comment}</b>',
    'explorer_comment_reply_wx' => '{author}在文件/夹:{fname}中回复了我的评论<b>{comment}</b>',
    'explorer_comment_reply_redirecturl' => '{url}',

    //群组成员变化
    'explorer_user_change_title' => '成员改变提醒',
    'explorer_user_change' => '{author}设置您为:<a class="text-primary" href="{url}" >{fname}</a> &nbsp;的{permtitle}',
    ...
    'explorer_user_add' => '{author}设置您为:<a class="text-primary" href="{url}">{fname}</a> &nbsp;的{permtitle}',
	...
	'bysize'=>'按大小',
	'bytime'=>'按名称',
	'all_or_part_of_the_file_name'=>'全部或部分文件名',
	'cancel_succeeded'=>'取消成功',
  'cancel_failed'=>'取消失败',
	'properties'=>'属性',
	'Copy_share_address'=>'复制分享地址',
	
	'file_location'=>'文件位置',
  'direct_chain_address'=>'直链地址',
	'generate_random_password'=>'生成随机密码',
	'prohibit_download'=>'禁止下载',
  'disable_preview'=>'禁用预览',
  'login_access_only'=>'仅登录访问',
	'tool'=>'工具',
	'set'=>'已设置',
);
