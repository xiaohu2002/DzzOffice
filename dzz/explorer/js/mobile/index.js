            ...
            if (scroll_flag == 1) {
                ...
                if (data) {
                    ...
                    $(window).scroll(function () {
                        ...
                        var scrollHeight = $(document).height()-80;
...
_filemanage.getNewIcos = function (data) {
    ...
    if (data['type'] == 'folder') {
        ...
        html = '<div class="weui-cell weui-cell_access weui-cell_longpress select-files" href="javascript:;"' +
            ' data-original="index.php?mod=io&op=thumbnail&path=' + data.dpath + '" data-rid="' + data.rid + '" rid="' + data.rid + '" data-collect="0" data-dpath="' + data.dpath + '" data-url="' + data.url + '"> ' +
