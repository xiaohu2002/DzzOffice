...
$lang = array (
  ...
  'inport_guide_notice'=>' Edit staff information sheet notes ',
	'inport_guide_notice_text'=>'<li>1. Edit the personnel information to be imported according to the template fields. If there is already a file information table, you only need to change the name of the relevant field in the existing file information table to be consistent with the name provided in the template. As long as the name corresponds, the position of the field does not affect the result</li>
