...
if(isset($_GET['lostpwsubmit'])) {
    ...
    $get_passwd_message = <<<EOT
      ...
      <p style="line-height: 24px; margin: 6px 0px 0px; overflow-wrap: break-word; word-break: break-all;"><span style="color: rgb(51, 51, 51); font-size: 14px;">您收到这封邮件，是由于这个邮箱地址在 $member[username] 被登记为用户邮箱，且该用户请求使用 Email 密码重置功能所致。</span></p>
