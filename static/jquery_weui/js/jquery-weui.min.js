...
!(function (t) {
  ...
  (t.fn.transitionEnd = function (t) {
    ...
    (t.getTouchPosition = function (t) {
      return (
        ...
        "touchmove" === t.type ||
        "touchend" === t.type
          ? { x: t.targetTouches[0].pageX, y: t.targetTouches[0].pageY }
          : { x: t.pageX, y: t.pageY }
      );
    }),
    ...
    (t.modal = function (n, i) {
      ...
      var a = n.buttons,
        r = a
          ...
          .join(""),
        o =
          '<div class="card weui-dialog"><div class="weui-dialog__hd"><strong class="weui-dialog__title">' +
          n.title +
          "</strong></div>" +
        ...
        return (
          "object" == typeof n
            ...
            : ("function" == typeof i && ((a = arguments[1]), (i = void 0)),
              (r = { text: n, title: i, onOK: a })),
          t.modal({
            text: r.text,
            title: r.title,
            buttons: [
              { text: e.buttonOK, className: "primary", onClick: r.onOK },
            ],
          })
        );
      }),
        ...
        return (
          "object" == typeof n
            ...
            : ("function" == typeof i &&
              ...
              (o = { text: n, title: i, onOK: a, onCancel: r })),
          t.modal({
            text: o.text,
            title: o.title,
            buttons: [
              ...
              { text: e.buttonOK, className: "primary", onClick: o.onOK },
            ],
          })
        );
      }),
  ...
  +(function (t) {
    "use strict";
    var e = function (n, i) {
      "function" == typeof i && (i = { onRefresh: i }),
        "string" == typeof i && (i = void 0),
        (this.opt = t.extend(e.defaults, i || {})),
        (this.container = t(n)),
        this.attachEvents();
    };
    (e.defaults = { distance: 50, onRefresh: void 0, onPull: void 0 }),
    ...
    var e = function (e) {
      ...
      function s() {
        (c.opened = !1),
          c.input &&
            c.input.length > 0 &&
            c.input.parents(".page-content").css({ "padding-bottom": "" }),
        ...
        (c.initPickerCol = function (e, n) {
          ...
          function r(e) {
            if (y) {
              ...
              (E = M + i),
                (_ = void 0),
                v > E && ((E = v - Math.pow(v - E, 0.8)), (_ = "min")),
  ...
  +(function (t) {
    ...
    var e,
      ...
      i = function (e, i) {
        (this.config = i),
          (this.data = { values: "", titles: "", origins: [], length: 0 }),
          (this.$input = t(e)),
  ...
  +(function (t) {
    ...
    (i.prototype = {
      ...
      getConfig: function () {
        var t,
          ...
          r = {
            ...
            cols: [
              ...
              { divider: !0, content: i.yearSplit },
              { values: this.initMonthes },
              { divider: !0, content: i.monthSplit },
              {
                values: (function () {
        ...
        i.dateSplit && r.cols.push({ divider: !0, content: i.dateSplit }),
          r.cols.push({ divider: !0, content: i.datetimeSplit });
    ...
    var e,
      ...
      l = function () {
        e.removeClass("touching"),
          e.attr("style", ""),
          0 > o && Math.abs(o) > 0.38 * e.height() && t.closeNotification(),
