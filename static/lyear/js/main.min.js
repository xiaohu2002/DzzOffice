jQuery(document).ready( function() {
    ...
    $("button:submit,input:submit,.sidebar-main a,.nav-pills .nav-link,.lyearloading").click(function(){
    ...
    $(document).on('click', '.nav-item-has-subnav > a', function() {
        ...
        $scrollBox    = $('.bs-left-container-info');
    ...
    // 读取cookie中的主题设置
	var the_logo_bg    = getcookie('the_logo_bg'),
	    the_header_bg  = getcookie('the_header_bg'),
	    the_sidebar_bg = getcookie('the_sidebar_bg'),
	    the_site_theme = getcookie('the_site_theme');
    ...
    showmessage = function ($msg, $type, $delay, $haveclose, $position, $callback, $url) {
        $type  = $type || 'info';
...
(function($) {
	...
	$.fn.popbox = function(options) {
		...
		var data_operate = function(html){
			box.find('.popover-body').html(html);
		...
		var close = function() {
			...
			box.fadeOut("fast", function() {
				box.find('.popover-body').html('<div class="loadding"></div>');
			});
